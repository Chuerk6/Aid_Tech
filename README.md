...
1. Clona el repositorio del backend:
  ```bash
  git clone https://github.com/Chuerk6/Aid_Tech/tree/16c6eb083286e499ccc4f55a9e41f1ec06961158/TP-Grupo1%20-%20backend
  ```
2. Navega al directorio del proyecto:
  ```bash
  cd TP-Grupo1 - backend
  ```
...
1. Clona el repositorio:
  ```bash
  git clone https://github.com/Chuerk6/Aid_Tech/tree/main/senhaliza-frontend
  ```
2. Navega al directorio del proyecto:
  ```bash
  cd senhaliza-frontend
  ```
3. Instala las dependencias
  ```bash
  npm install
